...
export const UPLOAD_SUBTITLE_EXT = ['srt', 'vtt', 'ass', 'gz'];
export const UPLOAD_SUBTITLE_TYPES = ['text/plain', 'application/gzip', 'application/x-gzip'];
...
export const UPLOAD_MEDIA_SOURCE_MAX_SIZE = 85899345920; // 80 GiB
